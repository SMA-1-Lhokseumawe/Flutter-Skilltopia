...
class _AddProfileState extends State<AddProfile> {
  ...
  Future<void> _fetchKelas() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Gagal mengambil daftar kelas')));
      }
    } catch (e) {
      print("Exception when fetching classes: $e");
      ScaffoldMessenger.of(
        context,
  ...
  Future<void> _createProfile() async {
    ...
    try {
      ...
      // Panggil API untuk menambahkan profil
      ...
      if (result['status']) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(result['message'] ?? 'Profil berhasil dibuat'),
          ),
        );
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(result['message'] ?? 'Gagal membuat profil')),
        );
      }
    } catch (error) {
      ScaffoldMessenger.of(
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: DropdownButtonFormField<String>(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Harap pilih jenis kelamin Anda';
                                }
                                return null;
                              },
                            ),
